...
const EIP20Abstraction = artifacts.require('TokenERC20');
let HST;

contract('TokenERC20', (accounts) => {
  beforeEach(async () => {
  ...
  it('transfers: should fail when trying to transfer 10001 to accounts[1] with accounts[0] having 10000', () => HST.transfer.call(accounts[1], 10001, { from: accounts[0] }));
...
/*
  ...
  it('approvals: attempt withdrawal from account with no allowance (should fail)', () => HST.transferFrom.call(accounts[0], accounts[2], 60, { from: accounts[1] }));
